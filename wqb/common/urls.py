...
URL_ALPHAS_ALPHAID_PNL = URL_ALPHAS_ALPHAID + '/recordsets/pnl'
URL_ALPHAS_ALPHAID_YEARLY_STATS = URL_ALPHAS_ALPHAID + '/recordsets/yearly-stats'
URL_ALPHAS_ALPHAID_CORRELATIONS_PROD = URL_ALPHAS_ALPHAID + '/correlations/prod'
...
URL_SPC_SUBMISSIONS = WQB_API_URL + '/competitions/spc/submissions'
